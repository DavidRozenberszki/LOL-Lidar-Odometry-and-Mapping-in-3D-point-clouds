...
% En ezt irnam a szovegebe-> From the total number of putative SegMap correspondences the proposed LOL algorithm detected a number of detected: true negative/true positive/false positive SegMap matches in case of different minimum cluster sizes. !!! Az ertekeket vissza kell irni az eredetire
}
